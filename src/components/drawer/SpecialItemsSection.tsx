                        ...
                        <div className="flex items-center justify-end gap-1.5 flex-nowrap">
                          ...
                          {hasAdminPermission && (
                            <button
                              ...
                              className="inline-flex items-center justify-center h-7 w-7 rounded-lg text-purple-400 bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/20 active:scale-[0.97] transition-all cursor-pointer shrink-0"
