...
import { Layers, ChevronDown, Edit2, AlertTriangle, Search, FileText, FolderOpen, FolderCheck, Copy } from "lucide-react";
          ...
          {poItems.length > 0 && (
            <div className="relative max-w-md group">
              <Input
                ...
                className="w-full bg-muted/50 border-border text-foreground h-9 rounded-lg text-xs outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/20 transition-all font-medium"
                style={{ paddingLeft: "2.5rem" }}
              />
              <Search
                className="absolute left-3 h-3.5 w-3.5 text-muted-foreground group-focus-within:text-indigo-400 transition-colors pointer-events-none z-10"
